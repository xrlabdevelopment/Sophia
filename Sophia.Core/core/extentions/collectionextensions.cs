...
namespace Sophia.Core.Extensions
{
    ...
    public static class CollectionExtensions
    {
        ...
        {
            return randomItem(source, Algorithms.Random.g_Random);
        }
        //-------------------------------------------------------------------------------------
        /// <summary>
        /// Returns a random element from a source.
        ...
        {
            return sampleRandom(source, sampleCount, Algorithms.Random.g_Random);
        }
        //-------------------------------------------------------------------------------------
        /// <summary>
        /// Returns a random sample from a source.
        ...
        {
            list.shuffle(Algorithms.Random.g_Random);
        }
        //-------------------------------------------------------------------------------------
        /// <summary>
        /// Shuffles a list.
